...
.method public static getOrCreateThreadId(Landroid/content/Context;Ljava/util/Set;)J
    ...
    sget-object v2, Landroid/provider/Telephony$Threads;->THREAD_ID_CONTENT_URI:Landroid/net/Uri;
    ...
    .line 1931
    const-string v2, "content://mms-sms/conversations/status"
    ...
    .line 1932
    .local v7, "statusUri":Landroid/net/Uri;
    invoke-virtual/range {p0 .. p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;
    ...
    const-string v5, "getOrCreateThreadId getOrCreateThreadId row "
    ...
    .end local v7    # "statusUri":Landroid/net/Uri;
    ...
    const-string v3, "update conversations status exception "
...
.method public static getOrCreateThreadIdInternal(Landroid/content/Context;Ljava/util/Set;)J
    ...
    const-string v1, "getOrCreateThreadIdInternal returned no rows!"
    ...
    const-string v3, "getOrCreateThreadIdInternal failed with uri "
