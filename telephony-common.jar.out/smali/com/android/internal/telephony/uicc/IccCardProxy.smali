...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setExternalState(Lcom/android/internal/telephony/IccCardConstants$State;)V

    goto :goto_0

    .line 223
    :sswitch_1
    iput-boolean v11, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mRadioOn:Z

    .line 224
    iget-boolean v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mInitialized:Z
    ...
    .line 234
    :sswitch_3
    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mAbsentRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-virtual {v8, v9}, Landroid/telephony/TelephonyManager;->getSimAppType(I)Ljava/lang/String;
    ...
    const-string v9, "update icc_operator_numeric="
    ...
    .line 253
    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual {v8, v9, v6}, Landroid/telephony/TelephonyManager;->setSimOperatorNumericForPhone(ILjava/lang/String;)V
    ...
    invoke-virtual {v8, v9, v10}, Landroid/telephony/TelephonyManager;->setSimCountryIsoForPhone(ILjava/lang/String;)V
    ...
    const-string v9, "gsm.ruim.cdmaimsi"
    ...
    .line 264
    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
    ...
    .line 266
    .local v5, "newCard":Lcom/android/internal/telephony/uicc/UiccCard;
    if-eqz v5, :cond_1

    .line 267
    invoke-virtual {v5, v11}, Lcom/android/internal/telephony/uicc/UiccCard;->getApplication(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;

    move-result-object v4

    .line 268
    .local v4, "newApp":Lcom/android/internal/telephony/uicc/UiccCardApplication;
    const/4 v7, 0x0
    ...
    const-string v9, "gsm.ruim.gsmimsi"
    ...
    .end local v4    # "newApp":Lcom/android/internal/telephony/uicc/UiccCardApplication;
    .end local v5    # "newCard":Lcom/android/internal/telephony/uicc/UiccCard;
    .end local v6    # "operator":Ljava/lang/String;
    .end local v7    # "records":Lcom/android/internal/telephony/uicc/IccRecords;
    :cond_1
    :goto_2
    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccCard:Lcom/android/internal/telephony/uicc/UiccCard;

    if-eqz v8, :cond_4

    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccCard:Lcom/android/internal/telephony/uicc/UiccCard;

    invoke-virtual {v8}, Lcom/android/internal/telephony/uicc/UiccCard;->areCarrierPriviligeRulesLoaded()Z
    ...
    invoke-virtual {v8, p0, v9, v12}, Lcom/android/internal/telephony/uicc/UiccCard;->registerForCarrierPrivilegeRulesLoaded(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    :cond_2
    const-string v8, "EVENT_RECORDS_LOADED Country code is null"
    ...
    .end local v2    # "countryCode":Ljava/lang/String;
    :cond_3
    const-string v8, "EVENT_RECORDS_LOADED Operator name is null"
    ...
    invoke-direct {p0, v8, v12}, Lcom/android/internal/telephony/uicc/IccCardProxy;->broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_0

    .line 294
    :sswitch_8
    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccApplication:Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    iput-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPersoSubState:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$PersoSubState;

    .line 295
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mNetworkLockedRegistrants:Landroid/os/RegistrantList;
    ...
    .line 302
    :sswitch_a
    const-string v8, "EVENT_SUBSCRIPTION_ACTIVATED"
    ...
    .line 307
    :sswitch_b
    const-string v8, "EVENT_SUBSCRIPTION_DEACTIVATED"
    ...
    :sswitch_d
    const-string v8, "EVENT_CARRIER_PRIVILEGES_LOADED"
    ...
    invoke-virtual {v8, p0}, Lcom/android/internal/telephony/uicc/UiccCard;->unregisterForCarrierPrivilegeRulesLoaded(Landroid/os/Handler;)V

    .line 328
    :cond_5
    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mExternalState:Lcom/android/internal/telephony/IccCardConstants$State;
