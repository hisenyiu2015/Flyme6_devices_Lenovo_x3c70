...
.method private constructor <init>(Lcom/android/internal/telephony/Phone;)V
    ...
    iput v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mPendingPhoneId:I
...
.method public setDefaultDataSubId(I)V
    ...
    .prologue
    .line 1578
    const-string v15, "setDefaultDataSubId"

    move-object/from16 v0, p0

    invoke-virtual {v0, v15}, Lcom/android/internal/telephony/SubscriptionController;->enforceModifyPhoneState(Ljava/lang/String;)V
    ...
    const-string v16, "setDefaultDataSubId: "
    ...
    invoke-direct {v0, v15}, Lcom/android/internal/telephony/SubscriptionController;->logd(Ljava/lang/String;)V

    .line 1580
    const-string v15, "persist.radio.flexmap_type"

    const-string v16, "nw_mode"
    ...
    const-string v16, "setDefaultDataSubId called with DEFAULT_SUB_ID"
    ...
    const-string v16, "[setDefaultDataSubId] subId="
    ...
    invoke-virtual {v0, v15}, Lcom/android/internal/telephony/SubscriptionController;->logdl(Ljava/lang/String;)V
    ...
    invoke-virtual {v15}, Lcom/android/internal/telephony/primarycard/PrimaryCardController;->getVSimSlot()I
    ...
    const-string v16, "setDataSubId:vsim:"
    ...
    .line 1592
    invoke-static {v14}, Landroid/telephony/SubscriptionManager;->isValidSlotId(I)Z
    ...
    .line 1597
    const-string v15, "setdefaultdata in DB"
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/SubscriptionController;->mContext:Landroid/content/Context;

    invoke-virtual {v15}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v15

    const-string v16, "multi_sim_data_call"
    ...
    .line 1608
    .local v11, "proxyController":Lcom/android/internal/telephony/ProxyController;
    sget-object v15, Lcom/android/internal/telephony/SubscriptionController;->sProxyPhones:[Lcom/android/internal/telephony/PhoneProxy;
    ...
    const-string v16, "[setDefaultDataSubId] num phones="
    ...
    .line 1614
    new-array v13, v7, [Landroid/telephony/RadioAccessFamily;

    .line 1615
    .local v13, "rafs":[Landroid/telephony/RadioAccessFamily;
    const/4 v2, 0x0

    .line 1616
    .local v2, "atLeastOneMatch":Z
    const/4 v10, 0x0
    ...
    .line 1619
    .local v9, "phone":Lcom/android/internal/telephony/PhoneProxy;
    ...
    const-string v16, "[setDefaultDataSubId] phoneId="
    ...
    .line 1629
    new-instance v15, Landroid/telephony/RadioAccessFamily;

    invoke-direct {v15, v10, v12}, Landroid/telephony/RadioAccessFamily;-><init>(II)V
    ...
    .line 1602
    .end local v2    # "atLeastOneMatch":Z
    .end local v5    # "id":I
    .end local v7    # "len":I
    .end local v9    # "phone":Lcom/android/internal/telephony/PhoneProxy;
    .end local v10    # "phoneId":I
    .end local v11    # "proxyController":Lcom/android/internal/telephony/ProxyController;
    .end local v12    # "raf":I
    .end local v13    # "rafs":[Landroid/telephony/RadioAccessFamily;
    :cond_3
    ...
    .line 1626
    .restart local v2    # "atLeastOneMatch":Z
    .restart local v5    # "id":I
    .restart local v7    # "len":I
    .restart local v9    # "phone":Lcom/android/internal/telephony/PhoneProxy;
    .restart local v10    # "phoneId":I
    .restart local v11    # "proxyController":Lcom/android/internal/telephony/ProxyController;
    .restart local v13    # "rafs":[Landroid/telephony/RadioAccessFamily;
    :cond_4
    invoke-virtual {v11}, Lcom/android/internal/telephony/ProxyController;->getMinRafSupported()I

    move-result v12

    .restart local v12    # "raf":I
    goto :goto_3
    ...
    .line 1632
    invoke-virtual {v11, v13}, Lcom/android/internal/telephony/ProxyController;->setRadioCapability([Landroid/telephony/RadioAccessFamily;)Z
    ...
    invoke-virtual {v0, v1, v15}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfo(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    invoke-virtual/range {v15 .. v17}, Lcom/android/internal/telephony/primarycard/PrimaryCardController;->getMode(ILjava/lang/String;)I
    ...
    const-string v16, "VOICE_MODE"

    const-string v17, "SRLTE"

    invoke-static/range {v15 .. v17}, Landroid/provider/Settings$Global;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .restart local v13    # "rafs":[Landroid/telephony/RadioAccessFamily;
    :cond_9
    const-string v15, "[setDefaultDataSubId] no valid subId\'s found - not updating."
    ...
    .end local v10    # "phoneId":I
    .end local v13    # "rafs":[Landroid/telephony/RadioAccessFamily;
    .restart local v6    # "info":Landroid/telephony/SubscriptionInfo;
