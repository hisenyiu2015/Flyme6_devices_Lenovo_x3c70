...
.field protected static final EVENT_GET_SIGNAL_STRENGTH_INTERNAL:I = 0x64
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/ServiceStateTracker;->packageName:Ljava/lang/String;
...
.method private maybeUpdateHDTag(Ljava/lang/String;)Ljava/lang/String;
    ...
    .restart local v0    # "hdTag":Ljava/lang/String;
    :cond_2
    move-object v1, p1
...
.method protected isCMCC(Ljava/lang/String;)Z
    .locals 1
...
.method protected isCT(Ljava/lang/String;)Z
    .locals 1
    .param p1, "inString"    # Ljava/lang/String;
...
.method protected isCU(Ljava/lang/String;)Z
    .locals 1
    .param p1, "inString"    # Ljava/lang/String;
...
.method protected translateStringForLocale(Ljava/lang/String;)Ljava/lang/String;
    .locals 10
    .param p1, "spnorplmn"    # Ljava/lang/String;
    ...
    const-string v8, "translateStringForLocale: spnorplmn "
    ...
    .line 1182
    .local v5, "tranlatedStr":Ljava/lang/String;
    const/4 v2, 0x0
    ...
    sget-object v8, Lcom/android/internal/telephony/ServiceStateTracker;->packageName:Ljava/lang/String;
    ...
    .line 1221
    .end local v5    # "tranlatedStr":Ljava/lang/String;
    .local v6, "tranlatedStr":Ljava/lang/String;
    :goto_1
    return-object v6

    .line 1191
    .end local v6    # "tranlatedStr":Ljava/lang/String;
    .restart local v5    # "tranlatedStr":Ljava/lang/String;
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/ServiceStateTracker;->isCMCC(Ljava/lang/String;)Z
    ...
    sget-object v9, Lcom/android/internal/telephony/ServiceStateTracker;->packageName:Ljava/lang/String;
    ...
    .line 1195
    const-string v7, "ro.lenovo.mobile.cta"
    ...
    .line 1196
    .local v0, "mEnabling":Z
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "updateSpnDisplay CTA mEnabling="
    ...
    invoke-virtual {v7, v8}, Landroid/telephony/TelephonyManager;->getDataNetworkType(I)I
    ...
    const-string v8, "updateSpnDisplay data rat:="
    ...
    invoke-virtual {v7, v8}, Landroid/telephony/TelephonyManager;->getVoiceNetworkType(I)I
    ...
    const-string v8, "updateSpnDisplay slot:="
    ...
    const-string v8, "updateSpnDisplay rat:="
    ...
    const-string v8, "updateSpnDisplay netclass:="
    ...
    .end local v0    # "mEnabling":Z
    .end local v1    # "netclass":I
    .end local v3    # "rat":I
    ...
    .line 1221
    .end local v5    # "tranlatedStr":Ljava/lang/String;
    .restart local v6    # "tranlatedStr":Ljava/lang/String;
    goto/16 :goto_1

    .line 1209
    .end local v6    # "tranlatedStr":Ljava/lang/String;
    .restart local v0    # "mEnabling":Z
    .restart local v1    # "netclass":I
    ...
    .end local v4    # "resId":I
    :cond_4
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/ServiceStateTracker;->isCU(Ljava/lang/String;)Z
    ...
    .end local v4    # "resId":I
    :cond_5
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/ServiceStateTracker;->isCT(Ljava/lang/String;)Z
