...
.method public sendSubscriptionSettings(Z)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/PhoneBase;->restoreSavedNetworkSelection(Landroid/os/Message;)V
...
.method public setPreferredApnBySlot(Ljava/lang/String;)V
    ...
    .prologue
    .line 2949
    const-string v0, "setPreferredApnBySlot"
...
.method protected setPreferredNetworkTypeIfSimLoaded()V
    ...
    invoke-virtual {v3, v1}, Lcom/android/internal/telephony/SubscriptionController;->isActiveSubId(I)Z
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/primarycard/PrimaryCardController;->isPrimaryLteSubEnabled()Z

    move-result v0

    .line 2733
    .local v0, "primarySubFeature":Z
    if-nez v0, :cond_0

    .line 2734
    const/4 v3, 0x0

    invoke-virtual {p0, v2, v3}, Lcom/android/internal/telephony/PhoneBase;->setPreferredNetworkType(ILandroid/os/Message;)V

    .line 2738
    .end local v0    # "primarySubFeature":Z
    .end local v2    # "type":I
    :cond_0
    return-void
.end method
