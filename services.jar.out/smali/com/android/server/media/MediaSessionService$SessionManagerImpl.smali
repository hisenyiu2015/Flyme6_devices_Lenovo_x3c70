...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;,
...
.field private static final MEDIA_DEBOUNCE_DELAY_MILLIS:J = 0x12cL
...
.field private mSendMediaKeyRunnable:Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;
...
.method static synthetic access$3102(Lcom/android/server/media/MediaSessionService$SessionManagerImpl;I)I
    .locals 0
    ...
    .prologue
    .line 634
    iput p1, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mHookKeyDownCount:I

    return p1
.end method

.method static synthetic access$3200(Lcom/android/server/media/MediaSessionService$SessionManagerImpl;Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/media/MediaSessionService$SessionManagerImpl;
...
.method private handleVoiceKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    invoke-virtual {p3, v8}, Lcom/android/server/media/MediaSessionRecord;->hasFlag(I)Z
    ...
    iput-boolean v8, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mVoiceButtonDown:Z

    .line 919
    const/4 v8, 0x0

    iput-boolean v8, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mVoiceButtonHandled:Z

    .line 921
    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->removeSendMediaKeyEvent()V
    ...
    .line 923
    .restart local v4    # "isLongPress":Z
    :cond_3
    iget-boolean v8, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mVoiceButtonDown:Z

    if-eqz v8, :cond_0

    iget-boolean v8, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mVoiceButtonHandled:Z
    ...
    .line 929
    .local v2, "isAudioActive":Z
    const/4 v5, 0x0

    .line 930
    .local v5, "isMusicActive":Z
    const/4 v3, 0x0

    .line 931
    .local v3, "isFmActive":Z
    if-eqz v1, :cond_4
    ...
    const-string v9, "MediaSessionHelper-com.lenovo.music"
    ...
    const-string v9, "dispatch music favorite event"
    ...
    invoke-direct {v6, v8, v9}, Landroid/view/KeyEvent;-><init>(II)V

    .line 939
    .local v6, "keyEvent_D":Landroid/view/KeyEvent;
    invoke-direct {p0, v6, p2, p3}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    invoke-direct {v7, v8, v9}, Landroid/view/KeyEvent;-><init>(II)V

    .line 941
    .local v7, "keyEvent_U":Landroid/view/KeyEvent;
    invoke-direct {p0, v7, p2, p3}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V

    goto :goto_0

    .line 943
    .end local v6    # "keyEvent_D":Landroid/view/KeyEvent;
    .end local v7    # "keyEvent_U":Landroid/view/KeyEvent;
    :cond_5
    ...
    .end local v2    # "isAudioActive":Z
    .end local v3    # "isFmActive":Z
    .end local v5    # "isMusicActive":Z
    :cond_6
    const/4 v8, 0x1
    ...
    .line 956
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->sendMediaKeyEvent(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
...
.method private removeSendMediaKeyEvent()V
    .locals 2

    .prologue
    .line 1189
    iget-object v0, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mSendMediaKeyRunnable:Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mHandler:Lcom/android/server/media/MediaSessionService$MessageHandler;
    invoke-static {v0}, Lcom/android/server/media/MediaSessionService;->access$2900(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionService$MessageHandler;

    move-result-object v0

    iget-object v1, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mSendMediaKeyRunnable:Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;
...
.method private sendMediaKeyEvent(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    .locals 6
    .param p1, "keyEvent"    # Landroid/view/KeyEvent;
    .param p2, "needWakeLock"    # Z
    .param p3, "session"    # Lcom/android/server/media/MediaSessionRecord;
    ...
    const-string v3, "Send media key, KeyEvent="
    ...
    .line 1198
    .local v0, "mHookKeyCode":I
    iget v1, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mHookKeyDownCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mHookKeyDownCount:I
    ...
    .line 1211
    iput v4, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mHookKeyDownCount:I
    ...
    .line 1217
    :cond_0
    new-instance v1, Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;

    invoke-direct {v1, p0, v0, p2, p3}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;-><init>(Lcom/android/server/media/MediaSessionService$SessionManagerImpl;IZLcom/android/server/media/MediaSessionRecord;)V

    iput-object v1, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mSendMediaKeyRunnable:Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;
    ...
    iget-object v2, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mSendMediaKeyRunnable:Lcom/android/server/media/MediaSessionService$SessionManagerImpl$SendMediaKeyRunnable;

    const-wide/16 v4, 0x12c

    invoke-virtual {v1, v2, v4, v5}, Lcom/android/server/media/MediaSessionService$MessageHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private startLeVoice(Z)V
    ...
    invoke-static {v4}, Lcom/android/server/media/MediaSessionService;->access$3000(Lcom/android/server/media/MediaSessionService;)Landroid/app/KeyguardManager;
