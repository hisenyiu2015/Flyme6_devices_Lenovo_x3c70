...
.field private mFPMediator:Lcom/android/server/fingerprint/FingerprintMediator;
...
.method static synthetic access$600(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    .prologue
    .line 87
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->onFPUsing()V
...
.method static synthetic access$700(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    .prologue
    .line 87
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->onFPRelease()V
...
.method private onFPRelease()V
    .locals 2

    .prologue
    .line 273
    iget-object v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mFPMediator:Lcom/android/server/fingerprint/FingerprintMediator;
    ...
    const-string v1, "onFPRelase() mFPMediator is null"
    ...
    invoke-virtual {v0}, Lcom/android/server/fingerprint/FingerprintMediator;->OnFPRelease()V

    goto :goto_0
.end method

.method private onFPUsing()V
    .locals 2
    ...
    const-string v1, "onFPUsing() mFPMediator is null"
    ...
    invoke-virtual {v0}, Lcom/android/server/fingerprint/FingerprintMediator;->OnFPUsing()V
...
.method protected handleAuthenticated(JII[I)V
    .locals 2
    .param p1, "deviceId"    # J
    .param p3, "fingerId"    # I
    .param p4, "groupId"    # I
    ...
    # invokes: Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->sendAuthenticated(II[I)Z
    invoke-static {v1, p3, p4, p5}, Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;->access$300(Lcom/android/server/fingerprint/FingerprintService$ClientMonitor;II[I)Z
...
.method public setMediator(Lcom/android/server/fingerprint/FingerprintMediator;)V
    ...
    const-string v1, "mediator is null"

    invoke-static {v0, v1}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    .line 166
    :cond_0
    iput-object p1, p0, Lcom/android/server/fingerprint/FingerprintService;->mFPMediator:Lcom/android/server/fingerprint/FingerprintMediator;
