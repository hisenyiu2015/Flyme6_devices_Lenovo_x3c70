...
.field private static final DIMMING_PATH:Ljava/lang/String; = "/sys/class/i2c-dev/i2c-11/device/11-0036/backlight/lm36923/dimming"
...
.field private mHasSetDimming:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayBlanker;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/display/DisplayPowerController;->mHasSetDimming:Z
...
.method private updatePowerState()V
    ...
    iget v12, v14, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->dozeScreenState:I
    ...
    invoke-direct {v0, v12, v9}, Lcom/android/server/display/DisplayPowerController;->animateScreenStateChange(IZ)V
    ...
    .line 626
    .local v13, "userInitiatedChange":Z
    :goto_a
    move-object/from16 v0, p0
    ...
    invoke-virtual {v15, v3, v0, v14, v13}, Lcom/android/server/display/AutomaticBrightnessController;->configure(ZFZZ)V

    .line 636
    .end local v4    # "autoBrightnessEnabledInDoze":Z
    .end local v13    # "userInitiatedChange":Z
    :cond_10
    move-object/from16 v0, p0
    ...
    .line 651
    .local v1, "CurrentAutoBrightnessEnabled":Z
    :goto_c
    if-eqz v1, :cond_13

    move-object/from16 v0, p0

    iget-boolean v14, v0, Lcom/android/server/display/DisplayPowerController;->mHasSetDimming:Z
    ...
    const-string v15, "/sys/class/i2c-dev/i2c-11/device/11-0036/backlight/lm36923/dimming"

    move-object/from16 v0, p0

    invoke-virtual {v0, v14, v15}, Lcom/android/server/display/DisplayPowerController;->writeSysFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-boolean v14, v0, Lcom/android/server/display/DisplayPowerController;->mHasSetDimming:Z

    .line 656
    const-string v14, "DisplayPowerController"

    const-string v15, "we need dim"
    ...
    .line 680
    .end local v1    # "CurrentAutoBrightnessEnabled":Z
    :goto_d
    if-gez v5, :cond_17
    ...
    const-string v15, "secondary brightness, do not need dim"
    ...
    iget v14, v0, Lcom/android/server/display/DisplayPowerController;->mBackLightGamma:F
    ...
    .line 626
    .restart local v13    # "userInitiatedChange":Z
    :cond_2d
    const/4 v14, 0x0
    ...
    .end local v4    # "autoBrightnessEnabledInDoze":Z
    .end local v13    # "userInitiatedChange":Z
    .restart local v11    # "slowChange":Z
    :cond_2e
    const/4 v1, 0x0
    ...
    .line 673
    .restart local v1    # "CurrentAutoBrightnessEnabled":Z
    :cond_2f
    const/4 v14, 0x0
    ...
    invoke-direct {v0, v5, v3}, Lcom/android/server/display/DisplayPowerController;->updateBrightness(IZ)I
