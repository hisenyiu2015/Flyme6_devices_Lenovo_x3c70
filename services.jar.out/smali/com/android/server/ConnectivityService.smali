...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/ConnectivityService$VsimClientDeathHandler;,
...
.field private static final DAEMON_DEFAULT_NAME:Ljava/lang/String; = "osi"
...
.field private static final MODE_DISCONNECT:Ljava/lang/String; = "disconnect"

.field private static final MODE_RUNNING:Ljava/lang/String; = "running"

.field private static final NETWORK_RESTORE_DELAY_PROP_NAME:Ljava/lang/String; = "android.telephony.apn-restore"

.field private static final NET_ESIM_INFO:Ljava/lang/String; = "net.ppp.esim-info"
...
.field private mIsInESimContainer:Z
...
.field private mVsimClientDeathHandlers:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->mIsInESimContainer:Z
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mVsimClientDeathHandlers:Ljava/util/List;
...
.method static synthetic access$4300(Lcom/android/server/ConnectivityService;Lcom/android/server/ConnectivityService$VsimClientDeathHandler;ZZ)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    .param p2, "x2"    # Z
    .param p3, "x3"    # Z

    .prologue
    .line 165
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/ConnectivityService;->exitESimNetwork(Lcom/android/server/ConnectivityService$VsimClientDeathHandler;ZZ)I
...
.method private exitESimNetwork(Lcom/android/server/ConnectivityService$VsimClientDeathHandler;ZZ)I
    .locals 8
    .param p1, "vsimHandler"    # Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    .param p2, "ignoreDups"    # Z
    .param p3, "restoreNormal"    # Z
    ...
    .line 4971
    iget v1, p1, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;->mPid:I

    .line 4972
    .local v1, "pid":I
    iget v2, p1, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;->mUid:I
    ...
    const-string v7, "sdl exitESimNetwork: pid "
    ...
    .line 4982
    :try_start_0
    iget-object v6, p0, Lcom/android/server/ConnectivityService;->mVsimClientDeathHandlers:Ljava/util/List;
    ...
    .line 4984
    const-string v5, "exitESimNetwork: this process has no outstanding requests -ignoring"
    ...
    .line 4988
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;->unlinkDeathRecipient()V

    .line 4989
    iget-object v6, p0, Lcom/android/server/ConnectivityService;->mVsimClientDeathHandlers:Ljava/util/List;

    iget-object v7, p0, Lcom/android/server/ConnectivityService;->mVsimClientDeathHandlers:Ljava/util/List;
    ...
    check-cast v3, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;

    .line 4999
    .local v3, "x":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    invoke-virtual {v3, p1}, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;->isSameUser(Lcom/android/server/ConnectivityService$VsimClientDeathHandler;)Z
    ...
    .line 5000
    const-string v5, "exitESimNetwork: dup is found, ignoring"
    ...
    .end local v3    # "x":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    :catchall_0
    move-exception v4
    ...
    invoke-direct {p0, v5, v4}, Lcom/android/server/ConnectivityService;->setESimStatus(ZI)V

    .line 5008
    if-eqz p3, :cond_3

    .line 5009
    const-string v4, "exitESimNetwork: restore normalcase"
...
.method private setESimStatus(ZI)V
    .locals 4
    .param p1, "enable"    # Z
    .param p2, "slotId"    # I
    ...
    const-string v2, "sdl setESimStatus enable="
    ...
    .line 5067
    iput-boolean p1, p0, Lcom/android/server/ConnectivityService;->mIsInESimContainer:Z

    .line 5069
    new-instance v0, Landroid/content/Intent;

    const-string v1, "android.net.conn.ESIM_MODE_CHANGED"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 5070
    .local v0, "intent":Landroid/content/Intent;
    const-string v1, "esimMode"

    invoke-virtual {v0, v1, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    .line 5071
    const-string v1, "esimSlot"
    ...
    .line 5074
    const-string v1, "net.ppp.esim-info"
...
.method public enterESim(Landroid/os/IBinder;I)I
    ...
    .line 4919
    const-string v4, "sdl enterESim binder == null "
    ...
    invoke-direct {p0, v4, p2}, Lcom/android/server/ConnectivityService;->setESimStatus(ZI)V

    .line 4924
    new-instance v3, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;

    invoke-direct {v3, p0, p1}, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;-><init>(Lcom/android/server/ConnectivityService;Landroid/os/IBinder;)V

    .line 4925
    .local v3, "vsimHandler":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    monitor-enter p0
    ...
    .line 4928
    .local v0, "addToList":Z
    :try_start_0
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mVsimClientDeathHandlers:Ljava/util/List;
    ...
    check-cast v2, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;

    .line 4929
    .local v2, "vsim":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    invoke-virtual {v2, v3}, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;->isSameUser(Lcom/android/server/ConnectivityService$VsimClientDeathHandler;)Z
    ...
    .line 4935
    .end local v2    # "vsim":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    :cond_2
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "sdl enterESim addToList="
...
.method public exitESim()I
    ...
    .line 4948
    .local v5, "vsimHandler":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    const/4 v0, 0x0
    ...
    check-cast v4, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;

    .line 4952
    .local v4, "vsim":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    invoke-virtual {v4, v2, v3}, Lcom/android/server/ConnectivityService$VsimClientDeathHandler;->isSameUser(II)Z
    ...
    .line 4958
    .end local v4    # "vsim":Lcom/android/server/ConnectivityService$VsimClientDeathHandler;
    :cond_1
    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v8, "sdl exitESim found="
    ...
    invoke-direct {p0, v5, v6, v7}, Lcom/android/server/ConnectivityService;->exitESimNetwork(Lcom/android/server/ConnectivityService$VsimClientDeathHandler;ZZ)I
    ...
    .restart local v1    # "i$":Ljava/util/Iterator;
    :cond_2
    const-string v7, "exitESim: X not a live request, ignoring"
...
.method public isInESimContainer()Z
    ...
    const-string v1, "sdl isInESimContainer ="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Lcom/android/server/ConnectivityService;->mIsInESimContainer:Z
    ...
    .line 5017
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->mIsInESimContainer:Z
...
.method public startDaemonService(Ljava/lang/String;)I
    ...
    .prologue
    .line 5084
    const-string v0, "sdl startDaemonService: "
...
.method public stopDaemonService(Ljava/lang/String;)I
    ...
    .prologue
    .line 5094
    const-string v0, "sdl stopDaemonService: "
