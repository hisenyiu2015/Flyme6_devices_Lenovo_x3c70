...
.method final processNextBroadcast(Z)V
    ...
    aget-object v40, v4, v23
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_0

    .line 898
    .local v40, "requiredPermission":Ljava/lang/String;
    :try_start_8
    ...
    .line 933
    .end local v23    # "i":I
    .end local v40    # "requiredPermission":Ljava/lang/String;
    :cond_17
    :goto_b
    if-nez v41, :cond_18
    ...
    invoke-interface {v4, v6, v7}, Landroid/content/pm/IPackageManager;->getApplicationEnabledSetting(Ljava/lang/String;I)I
    ...
    const-string v7, " gms broadcast skip :"
    ...
    .line 903
    .end local v34    # "opCode":I
    .restart local v23    # "i":I
    .restart local v40    # "requiredPermission":Ljava/lang/String;
    :catch_1
    move-exception v19
    ...
    .end local v19    # "e":Landroid/os/RemoteException;
    :cond_20
    invoke-static/range {v40 .. v40}, Landroid/app/AppOpsManager;->permissionToOpCode(Ljava/lang/String;)I
    ...
    invoke-static/range {v40 .. v40}, Landroid/app/AppOpsManager;->permissionToOp(Ljava/lang/String;)Ljava/lang/String;
