...
.field private static final SUB_SET_UICC_FAIL:I = -0x64
...
.method public activateSubId(I)V
    ...
    const-string v5, "activateSubId: subId "
    ...
    .line 427
    .local v2, "slotId":I
    invoke-virtual {v0, v2}, Lcom/qti/internal/telephony/ExtTelephonyServiceImpl;->activateUiccCard(I)I
    ...
    const-string v5, "activateSubId: result: "
    ...
    .line 431
    invoke-virtual {p0, p1}, Lcom/qti/internal/telephony/QtiSubscriptionController;->getSubState(I)I
    ...
    .line 433
    invoke-virtual {p0, p1, v6}, Lcom/qti/internal/telephony/QtiSubscriptionController;->setSubState(II)I

    .line 442
    .end local v3    # "subStatus":I
    :cond_1
    return-void
.end method
...
.method public deactivateSubId(I)V
    ...
    const-string v5, "deactivateSubId: subId "
    ...
    .line 450
    .local v2, "slotId":I
    invoke-virtual {v0, v2}, Lcom/qti/internal/telephony/ExtTelephonyServiceImpl;->deactivateUiccCard(I)I
    ...
    const-string v5, "deactivateSubId: result: "
    ...
    invoke-virtual {p0, p1, v4}, Lcom/qti/internal/telephony/QtiSubscriptionController;->setSubState(II)I
...
.method declared-synchronized updateUserPreferences()V
    ...
    .line 285
    .local v4, "mNextActivatedSub":Landroid/telephony/SubscriptionInfo;
    const/4 v0, 0x0
    ...
    .line 284
    .end local v6    # "sil":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubscriptionInfo;>;"
    :catchall_0
    move-exception v7
    ...
    .line 302
    .restart local v6    # "sil":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubscriptionInfo;>;"
    :cond_2
    :try_start_2
    ...
    const-string v8, "updateUserPrefs: before dds dds = "
    ...
    .line 323
    .local v2, "ddsSubId":I
    invoke-virtual {p0, v2}, Lcom/qti/internal/telephony/QtiSubscriptionController;->getSlotId(I)I
    ...
    const-string v8, "updateUserPrefs:dataSlot:"
    ...
    invoke-virtual {p0, v7, v8}, Lcom/qti/internal/telephony/QtiSubscriptionController;->getActiveSubscriptionInfoForSimSlotIndex(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    :cond_6
    invoke-virtual {p0, v2}, Lcom/qti/internal/telephony/QtiSubscriptionController;->setDefaultDataSubId(I)V

    .line 330
    invoke-virtual {p0, v2}, Lcom/qti/internal/telephony/QtiSubscriptionController;->setDefaultFallbackSubId(I)V
    :try_end_2
