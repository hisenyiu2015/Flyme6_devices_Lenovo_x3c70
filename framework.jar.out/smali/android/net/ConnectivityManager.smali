...
.field public static final ACTION_ESIM_MODE_CHANGED:Ljava/lang/String; = "android.net.conn.ESIM_MODE_CHANGED"
...
.field public static final EXTRA_ESIM_MODE:Ljava/lang/String; = "esimMode"

.field public static final EXTRA_ESIM_SLOT:Ljava/lang/String; = "esimSlot"
...
.field public static final TETHER_ERROR_EXCEPTION_ERROR:I = 0xb
...
.method public enterESim(Landroid/os/IBinder;I)I
    ...
    invoke-interface {v1, p1, p2}, Landroid/net/IConnectivityManager;->enterESim(Landroid/os/IBinder;I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public exitESim()I
    ...
    invoke-interface {v1}, Landroid/net/IConnectivityManager;->exitESim()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isInESimContainer()Z
    ...
    invoke-interface {v1}, Landroid/net/IConnectivityManager;->isInESimContainer()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public startDaemonService(Ljava/lang/String;)I
    ...
    invoke-interface {v1, p1}, Landroid/net/IConnectivityManager;->startDaemonService(Ljava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public stopDaemonService(Ljava/lang/String;)I
    ...
    invoke-interface {v1, p1}, Landroid/net/IConnectivityManager;->stopDaemonService(Ljava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public tether(Ljava/lang/String;)I
    ...
    invoke-interface {v6, p1}, Landroid/net/IConnectivityManager;->tether(Ljava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
