...
.method public readNetworkVariablesFromSupplicantFile(Ljava/lang/String;)Landroid/net/wifi/WifiShareInfo;
    ...
    .line 2270
    sget-object v3, Landroid/net/wifi/WifiShareInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v3, v1}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/net/wifi/WifiShareInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 2277
    .local v2, "_result":Landroid/net/wifi/WifiShareInfo;
    :goto_0
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 2273
    .end local v2    # "_result":Landroid/net/wifi/WifiShareInfo;
    :cond_0
    const/4 v2, 0x0

    .restart local v2    # "_result":Landroid/net/wifi/WifiShareInfo;
    goto :goto_0
