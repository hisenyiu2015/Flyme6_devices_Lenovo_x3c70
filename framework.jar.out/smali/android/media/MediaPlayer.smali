...
.field private static final mHifiSupportedMediaApps:Ljava/util/HashSet;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/media/MediaPlayer;->mHifiSupportedMediaApps:Ljava/util/HashSet;
...
.method public constructor <init>()V
    ...
    .line 3887
    iput-boolean v4, p0, Landroid/media/MediaPlayer;->mIsHifiApp:Z

    .line 3888
    iput-boolean v4, p0, Landroid/media/MediaPlayer;->mIsHeadsetPresent:Z

    .line 3890
    const/16 v2, 0x4000

    iput v2, p0, Landroid/media/MediaPlayer;->AUDIO_OUTPUT_FLAG_HIFI:I

    .line 636
    const-string v2, "MediaPlayer"

    const-string v3, "HIFI MediaPlayer()"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 637
    invoke-direct {p0}, Landroid/media/MediaPlayer;->isHiFiApp()Z

    move-result v2

    iput-boolean v2, p0, Landroid/media/MediaPlayer;->mIsHifiApp:Z
...
.method private native _setFlags(I)I
.end method
...
.method private isHiFiUsed()Z
    ...
    const-string/jumbo v3, "isHiFiUsed: calling packagename is : "
    ...
    .line 3931
    .local v0, "rv":Z
    invoke-direct {p0}, Landroid/media/MediaPlayer;->isWiredHeadsetOn()Z

    move-result v1

    iput-boolean v1, p0, Landroid/media/MediaPlayer;->mIsHeadsetPresent:Z

    .line 3932
    iget-boolean v1, p0, Landroid/media/MediaPlayer;->mIsHifiApp:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Landroid/media/MediaPlayer;->mIsHeadsetPresent:Z
    ...
    const-string v2, "headset present and hifi app"
    ...
    const-string/jumbo v3, "out isHiFiUsed "
...
.method private isWiredHeadsetOn()Z
    ...
    const-string v2, "in isWiredHeadsetOn"
...
.method private setDataSource(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v6, "HIFI setDataSource()"

    invoke-static {v5, v6}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1097
    invoke-direct {p0}, Landroid/media/MediaPlayer;->setFlags()V
...
.method private setFlags()V
    ...
    const-string/jumbo v2, "setFlags: calling packagename is : "
    ...
    iput-boolean v0, p0, Landroid/media/MediaPlayer;->mIsHeadsetPresent:Z

    .line 3943
    iget-boolean v0, p0, Landroid/media/MediaPlayer;->mIsHifiApp:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Landroid/media/MediaPlayer;->mIsHeadsetPresent:Z
    ...
    const-string v1, "headset present and hifi app"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3945
    iget v0, p0, Landroid/media/MediaPlayer;->AUDIO_OUTPUT_FLAG_HIFI:I

    invoke-direct {p0, v0}, Landroid/media/MediaPlayer;->_setFlags(I)I

    .line 3947
    :cond_0
    const-string v0, "MediaPlayer"

    const-string/jumbo v1, "out setFlags"
...
.method public setDataSource(Ljava/io/FileDescriptor;JJ)V
    ...
    const-string v1, "HIFI setDataSource()"
