...
.field public static final FLAG_HEADPHONE_VOLUME_AUTO_LOW:I = 0x100

.field public static final FLAG_HEADSET_VOLUME_AUTO_LOW:I = 0x80
...
.field private static final mHIFISamplerate:Ljava/util/HashSet;
...
.field private static final mHifiSupportedApps:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/media/AudioManager;->mHifiSupportedApps:Ljava/util/HashSet;
    ...
    sput-object v0, Landroid/media/AudioManager;->mHIFISamplerate:Ljava/util/HashSet;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 4283
    sget-object v0, Landroid/media/AudioManager;->mHIFISamplerate:Ljava/util/HashSet;
...
.method public static getSupportedHifiApps()Ljava/util/HashSet;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 4262
    sget-object v0, Landroid/media/AudioManager;->mHifiSupportedApps:Ljava/util/HashSet;
    ...
    const-string/jumbo v1, "miguyy.lingxicloud.com"
...
.method public static getSupportedHifiSamplerates()Ljava/util/HashSet;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public forceVolumeControlStream(I)V
    ...
    const-string v4, "in forceVolumeControlStream : "
...
.method public getParameters(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "in getParameters : "
...
.method public inHifiAppsSwitch(Ljava/lang/String;)Z
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->inHifiAppsSwitch(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setParameters(Ljava/lang/String;)V
    ...
    const-string v2, "in setParameters : "
    ...
    const-string v0, "HIFI_SWITCH=true"
    ...
    const-string v1, "hifi_switch_state"
    ...
    :cond_1
    const-string v0, "HIFI_SWITCH=false"
...
.method public setRingerMode(I)V
    ...
    const-string v4, "in setRingerMode mode : "
...
.method public updateHifiAppsSwitch(Ljava/lang/String;Z)V
    ...
    .local v0, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v0, p1, p2}, Landroid/media/IAudioService;->updateHifiAppsSwitch(Ljava/lang/String;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
