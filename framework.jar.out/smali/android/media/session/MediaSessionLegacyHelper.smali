...
.field private static mHasVolumeKeyLongPress:Z
...
# instance fields
.field private isVolumeKeyDown:Z

.field private isVolumeKeyHandled:Z

.field private mContext:Landroid/content/Context;

.field private mHandler:Landroid/os/Handler;

.field private final mIsVolumeKeyLongpress:Ljava/lang/Runnable;
...
.method static constructor <clinit>()V
    ...
    .line 182
    sput-boolean v2, Landroid/media/session/MediaSessionLegacyHelper;->mHasVolumeKeyLongPress:Z

    .line 183
    sput v2, Landroid/media/session/MediaSessionLegacyHelper;->mNewKeyCode:I
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 62
    iput-boolean v2, p0, Landroid/media/session/MediaSessionLegacyHelper;->isVolumeKeyDown:Z

    .line 63
    iput-boolean v2, p0, Landroid/media/session/MediaSessionLegacyHelper;->isVolumeKeyHandled:Z
    ...
    iput-object v0, p0, Landroid/media/session/MediaSessionLegacyHelper;->mIsVolumeKeyLongpress:Ljava/lang/Runnable;
...
.method static synthetic access$002(Z)Z
    ...
    .prologue
    .line 47
    sput-boolean p0, Landroid/media/session/MediaSessionLegacyHelper;->mHasVolumeKeyLongPress:Z
...
.method public sendVolumeKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    .line 223
    iget-object v6, p0, Landroid/media/session/MediaSessionLegacyHelper;->mHandler:Landroid/os/Handler;

    iget-object v8, p0, Landroid/media/session/MediaSessionLegacyHelper;->mIsVolumeKeyLongpress:Ljava/lang/Runnable;
    ...
    .line 225
    sput-boolean v7, Landroid/media/session/MediaSessionLegacyHelper;->mHasVolumeKeyLongPress:Z

    .line 226
    sput v4, Landroid/media/session/MediaSessionLegacyHelper;->mNewKeyCode:I
    ...
    iget-object v7, p0, Landroid/media/session/MediaSessionLegacyHelper;->mIsVolumeKeyLongpress:Ljava/lang/Runnable;

    invoke-virtual {v6, v7}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 230
    sget-boolean v6, Landroid/media/session/MediaSessionLegacyHelper;->mHasVolumeKeyLongPress:Z
    ...
    const-string/jumbo v7, "press action,send volume key"
    ...
    invoke-virtual {v6, v9, v0, v2}, Landroid/media/session/MediaSessionManager;->dispatchAdjustVolume(III)V
    ...
    invoke-virtual {v6, v9, v7, v2}, Landroid/media/session/MediaSessionManager;->dispatchAdjustVolume(III)V
