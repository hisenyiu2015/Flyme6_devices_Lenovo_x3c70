...
.method private static switchToSinlehandRect(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .line 728
    .local v4, "mAm":Landroid/app/IActivityManager;
    invoke-interface {v4}, Landroid/app/IActivityManager;->getGlobalTransform()Landroid/view/animation/Transformation;

    move-result-object v5

    .line 729
    .local v5, "mTransformation":Landroid/view/animation/Transformation;
    if-eqz v5, :cond_1
    ...
    invoke-virtual {v7, p0}, Landroid/graphics/RectF;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v7, v6}, Landroid/graphics/RectF;->round(Landroid/graphics/Rect;)V
    :try_end_0
    ...
    .line 744
    .end local v4    # "mAm":Landroid/app/IActivityManager;
    .end local v5    # "mTransformation":Landroid/view/animation/Transformation;
