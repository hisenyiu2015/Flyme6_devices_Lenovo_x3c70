...
.method static synthetic access$1000(Llenovo/widget/ListPopupWindow$ForwardingListener;)V
    .locals 0
    .param p0, "x0"    # Llenovo/widget/ListPopupWindow$ForwardingListener;
...
.method static synthetic access$900(Llenovo/widget/ListPopupWindow$ForwardingListener;)Landroid/view/View;
    .locals 1
    .param p0, "x0"    # Llenovo/widget/ListPopupWindow$ForwardingListener;
...
.method private onTouchForwarded(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v5}, Llenovo/widget/ListPopupWindow;->access$600(Llenovo/widget/ListPopupWindow;)Llenovo/widget/ListPopupWindow$DropDownListView;
    ...
    .line 1425
    iget v9, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mActivePointerId:I

    invoke-virtual {v1, v2, v9}, Llenovo/widget/ListPopupWindow$DropDownListView;->onForwardedEvent(Landroid/view/MotionEvent;I)Z
...
.method private onTouchObserved(Landroid/view/MotionEvent;)Z
    ...
    iput v6, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mActivePointerId:I

    .line 1332
    iput-boolean v5, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mWasLongPress:Z

    .line 1334
    iget-object v6, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;

    if-nez v6, :cond_2

    .line 1335
    new-instance v6, Llenovo/widget/ListPopupWindow$ForwardingListener$DisallowIntercept;

    invoke-direct {v6, p0, v10}, Llenovo/widget/ListPopupWindow$ForwardingListener$DisallowIntercept;-><init>(Llenovo/widget/ListPopupWindow$ForwardingListener;Llenovo/widget/ListPopupWindow$1;)V

    iput-object v6, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;

    .line 1337
    :cond_2
    iget-object v6, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;

    iget v7, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mTapTimeout:I
    ...
    .line 1338
    iget-object v6, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    if-nez v6, :cond_3

    .line 1339
    new-instance v6, Llenovo/widget/ListPopupWindow$ForwardingListener$TriggerLongPress;

    invoke-direct {v6, p0, v10}, Llenovo/widget/ListPopupWindow$ForwardingListener$TriggerLongPress;-><init>(Llenovo/widget/ListPopupWindow$ForwardingListener;Llenovo/widget/ListPopupWindow$1;)V

    iput-object v6, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    .line 1341
    :cond_3
    iget-object v6, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    iget v7, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mLongPressTimeout:I
    ...
    .line 1344
    :pswitch_1
    iget v7, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mActivePointerId:I
    ...
    .line 1348
    .local v4, "y":F
    iget v7, p0, Llenovo/widget/ListPopupWindow$ForwardingListener;->mScaledTouchSlop:F

    invoke-static {v2, v3, v4, v7}, Llenovo/widget/ListPopupWindow$ForwardingListener;->pointInView(Landroid/view/View;FFF)Z
