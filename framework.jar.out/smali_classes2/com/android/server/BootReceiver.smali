...
.field private static final SUBSYSNAME_MAP:Ljava/util/Map;
...
.field private static mSilentPanicObserver:Landroid/os/UEventObserver;
...
.method static constructor <clinit>()V
    ...
    .line 67
    sput-object v2, Lcom/android/server/BootReceiver;->sTombstoneObserver:Landroid/os/FileObserver;
    ...
    sput-object v0, Lcom/android/server/BootReceiver;->SUBSYSNAME_MAP:Ljava/util/Map;

    .line 76
    sput-object v2, Lcom/android/server/BootReceiver;->mSilentPanicObserver:Landroid/os/UEventObserver;
...
.method public constructor <init>()V
    ...
    .line 71
    sget-object v0, Lcom/android/server/BootReceiver;->SUBSYSNAME_MAP:Ljava/util/Map;

    const-string v1, "adsp"

    const-string v2, "ADSP_SILENT_PAINC"
    ...
    const-string v2, "MODEM_SILENT_PAINC"
    ...
    const-string v2, "WIFI_SILENT_PAINC"
    ...
    const-string v1, "other_ss"

    const-string v2, "OTHER_SS_SILENT_PAINC"
...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    const-string v5, "ro.boot.bootreason"
    ...
    .line 133
    .local v14, "lastKmsgFooter":Ljava/lang/String;
    if-eqz v12, :cond_1
    ...
    const-string v6, "/data/local/log/mrd_ue/summary.txt"
    ...
    const-string v6, "SYSTEM_AUDIT"

    invoke-static {v2, v3, v4, v5, v6}, Lcom/android/server/BootReceiver;->addAuditErrorsToDropBox(Landroid/os/DropBoxManager;Landroid/content/SharedPreferences;Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v6, "SYSTEM_FSCK"

    invoke-static {v2, v3, v4, v5, v6}, Lcom/android/server/BootReceiver;->addFsckErrorsToDropBox(Landroid/os/DropBoxManager;Landroid/content/SharedPreferences;Ljava/lang/String;ILjava/lang/String;)V
    ...
    :cond_7
    new-instance v5, Lcom/android/server/BootReceiver$2;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/android/server/BootReceiver$2;-><init>(Lcom/android/server/BootReceiver;Ljava/lang/String;ILandroid/os/DropBoxManager;Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v0, v2, v4}, Lcom/android/server/BootReceiver$3;-><init>(Lcom/android/server/BootReceiver;Landroid/os/DropBoxManager;Ljava/lang/String;)V

    sput-object v5, Lcom/android/server/BootReceiver;->mSilentPanicObserver:Landroid/os/UEventObserver;

    .line 217
    sget-object v5, Lcom/android/server/BootReceiver;->mSilentPanicObserver:Landroid/os/UEventObserver;

    const-string v6, "SSR_ID=mrd_ue"
