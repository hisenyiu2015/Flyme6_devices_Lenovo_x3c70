...
.method private setItem(Landroid/view/MenuItem;)V
    ...
    .line 427
    iget-boolean v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemChecked:Z

    invoke-interface {p1, v3}, Landroid/view/MenuItem;->setChecked(Z)Landroid/view/MenuItem;

    move-result-object v3

    iget-boolean v5, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemVisible:Z

    invoke-interface {v3, v5}, Landroid/view/MenuItem;->setVisible(Z)Landroid/view/MenuItem;

    move-result-object v3

    iget-boolean v5, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemEnabled:Z

    invoke-interface {v3, v5}, Landroid/view/MenuItem;->setEnabled(Z)Landroid/view/MenuItem;

    move-result-object v5

    iget v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemCheckable:I
    ...
    iget-object v5, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemTitleCondensed:Ljava/lang/CharSequence;

    invoke-interface {v3, v5}, Landroid/view/MenuItem;->setTitleCondensed(Ljava/lang/CharSequence;)Landroid/view/MenuItem;

    move-result-object v3

    iget v5, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemIconResId:I

    invoke-interface {v3, v5}, Landroid/view/MenuItem;->setIcon(I)Landroid/view/MenuItem;

    move-result-object v3

    iget-char v5, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemAlphabeticShortcut:C

    invoke-interface {v3, v5}, Landroid/view/MenuItem;->setAlphabeticShortcut(C)Landroid/view/MenuItem;

    move-result-object v3

    iget-char v5, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemNumericShortcut:C

    invoke-interface {v3, v5}, Landroid/view/MenuItem;->setNumericShortcut(C)Landroid/view/MenuItem;

    .line 436
    iget v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemShowAsAction:I
    ...
    .line 440
    :cond_0
    iget-object v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemListenerMethodName:Ljava/lang/String;
    ...
    .line 445
    :cond_2
    new-instance v3, Lcom/lenovo/internal/view/SupportMenuInflater$InflatedOnMenuItemClickListener;

    iget-object v5, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->this$0:Lcom/lenovo/internal/view/SupportMenuInflater;

    # invokes: Lcom/lenovo/internal/view/SupportMenuInflater;->getRealOwner()Ljava/lang/Object;
    invoke-static {v5}, Lcom/lenovo/internal/view/SupportMenuInflater;->access$400(Lcom/lenovo/internal/view/SupportMenuInflater;)Ljava/lang/Object;

    move-result-object v5

    iget-object v6, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemListenerMethodName:Ljava/lang/String;

    invoke-direct {v3, v5, v6}, Lcom/lenovo/internal/view/SupportMenuInflater$InflatedOnMenuItemClickListener;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 449
    :cond_3
    instance-of v3, p1, Lcom/lenovo/internal/view/menu/MenuItemImpl;
    ...
    .line 450
    .local v2, "impl":Lcom/lenovo/internal/view/menu/MenuItemImpl;
    :goto_1
    iget v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemCheckable:I
    ...
    invoke-virtual {v3, v4}, Lcom/lenovo/internal/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V
    ...
    iget-object v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemActionViewClassName:Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/lenovo/internal/view/SupportMenuInflater;->access$600(Lcom/lenovo/internal/view/SupportMenuInflater;)[Ljava/lang/Object;

    move-result-object v5

    invoke-direct {p0, v3, v4, v5}, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->newInstance(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_5
    iget v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemActionViewLayout:I
    ...
    :cond_6
    :goto_3
    iget-object v3, p0, Lcom/lenovo/internal/view/SupportMenuInflater$MenuState;->itemActionProvider:Llenovo/view/ActionProvider;

    if-eqz v3, :cond_7

    .line 475
    instance-of v3, p1, Lcom/lenovo/internal/view/SupportMenuItem;
    ...
    invoke-interface {p1, v3}, Lcom/lenovo/internal/view/SupportMenuItem;->setSupportActionProvider(Llenovo/view/ActionProvider;)Lcom/lenovo/internal/view/SupportMenuItem;
    ...
    .end local v2    # "impl":Lcom/lenovo/internal/view/menu/MenuItemImpl;
    ...
    .line 453
    .restart local v2    # "impl":Lcom/lenovo/internal/view/menu/MenuItemImpl;
    :cond_9
    instance-of v3, p1, Lcom/lenovo/internal/view/menu/MenuItemWrapperICS;
    ...
    .line 454
    check-cast v3, Lcom/lenovo/internal/view/menu/MenuItemWrapperICS;

    invoke-virtual {v3, v4}, Lcom/lenovo/internal/view/menu/MenuItemWrapperICS;->setExclusiveCheckable(Z)V
